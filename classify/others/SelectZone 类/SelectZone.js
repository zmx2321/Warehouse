...
location.href.lastIndexOf("?")) + "?is_ajax=1";
  var _self = this;
  ...
  {
    Ajax.call(this.filename+"&act=" + act, filters, this.loadOptionsResponse, "GET", 
...
"JSON");
  ...
  this.addItem = function(all, act)
  {
    ...
    if (selOpt.length > 0)
    {
      ...
      Ajax.call(this.filename + "&act="+act+"&add_ids=" +selOpt.toJSONString(), args, 

this.addRemoveItemResponse, "GET", "JSON");
    }
  }
  ...
  this.dropItem = function(all, act)
  {
    ...
    if (arr.length > 0)
    {
      ...
      Ajax.call(this.filename + "&act="+act+"&drop_ids=" + arr.toJSONString(), args, 
